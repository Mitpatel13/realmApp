...
class RealmServices with ChangeNotifier {
  ...
  void createItem(String summary, bool isComplete, String division,String classes) {
    final newItem =
        Item(ObjectId(), summary, currentUser!.id, isComplete: isComplete,classes: classes,division: division);
